...
setTimeout(function() {
  window.tinymce && tinymce.init({
    ...
    templates: [
      <?php echo \Boelter\DynamicTemplates\Backend\DataContainer\DynamicTemplate::loadTemplatesForSelector($selector); ?>
    ],
    ...
    toolbar: 'template | link unlink | image | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | undo redo | code'
  });
}, 0);
</script>
<?php endif; ?>
